...
(
    ...
    billing_order_amount_ht                 STRING  COMMENT 'Montant bon de commande HT(en Euros)'                                                       ,
    ...
    affranchigo_service_amount              STRING  COMMENT 'Montant de la prestation Affranchigo'                                                       ,
    next_invoice_credit                     STRING  COMMENT 'next_invoice_credit'
)
